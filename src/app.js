...
const exercises = {
  ankle: [
    {
      name: "弹力带踝背屈（半跪）", sets: "2组 × 10次", badge: "PT HEP",
      timerType: "reps", reps: 10, sets_n: 2,
      brief: "弹力带套踝前，脚跟踩实，膝盖向前推",
      category: "warmup",
    ...
    {
      name: "单腿站姿提踵", sets: "3组 × 10次", badge: "PT HEP",
      timerType: "reps", reps: 10, sets_n: 3,
      brief: "单腿站立，踮起脚尖再慢慢落下",
      setup: "站在椅背或台面边可扶的位置，右脚单腿站立，脚尖朝前。手扶支撑物只用于平衡，不向下借力。",
      steps: [
        "右脚脚掌向下推地作为发力起点",
        "缓慢踮起脚跟，身体向上而不是向前晃",
        "最高点保持1秒，感受小腿后侧主动收缩",
    ...
    {
      name: "弓步位比目鱼肌提踵", sets: "2组 × 10次", badge: "PT HEP",
      timerType: "reps", reps: 10, sets_n: 2,
      brief: "前腿承重，双脚脚跟抬起，在弓步中上下移动",
      setup: "进入分腿弓步站姿，右脚在前。双脚脚跟都保持抬起，膝盖微屈，手可以扶墙或栏杆保持平衡。",
      steps: [
        "保持两个脚跟抬起，不让后脚跟落地",
        "身体在弓步范围内缓慢上下移动",
        "重点感受前腿小腿深层（比目鱼肌）工作",
    ...
    {
      name: "双脚踝弹跳 Pogo Hop", sets: "3组 × 30秒", badge: "PT HEP",
      timerType: "hold", duration: 30, sets_n: 3,
      brief: "双脚小幅连续弹跳，像脚踝弹簧一样轻快",
      setup: "双脚与髋同宽站立，膝盖微屈，身体直立。选择平整地面，身边留有可扶的墙或栏杆。先从非常小的弹跳幅度开始。",
      steps: [
        "双脚前脚掌轻轻推地，身体小幅离地",
        "落地后快速、轻柔地再次弹起",
        "保持节奏连续，膝盖只微微弯曲",
    ...
    {
      name: "单腿 RDL（HEP版）", sets: "2组 × 每侧10次", badge: "PT HEP",
      timerType: "reps", reps: 10, sets_n: 2,
      brief: "单腿髋铰链，身体前倾、后腿向后伸",
      setup: "站在墙边或栏杆旁，右腿单腿支撑，膝盖微屈。双手可轻扶支撑物。左腿自然向后延伸准备。",
      steps: [
        "从髋部发起动作，屁股向后推",
        "身体向前倾，同时后腿向后抬，形成长线",
        "支撑腿膝盖保持微屈，不锁死",
  ...
  spine: [
    ...
    {
      name: "胸椎伸展 · 手贴胸（PT 处方）", sets: "2组 × 10次", badge: "PT HEP",
      timerType: "reps", reps: 10, sets_n: 2,
      brief: "仰卧泡沫轴 · 双手交叉贴胸 · 腿推动滚轴",
      category: "main",
      setup: "仰卧地面，膝盖弯曲、双脚踩地；泡沫轴横放在上背下方（肩胛骨区域起始）。双手交叉贴在胸前和肋骨上（一只手扶对侧肋骨）。这与抱头版本不同——手在胸前，靠核心和颈部自身稳定头部。",
      steps: [
        "起始位：泡沫轴在上背中段（约 T4–T7），双手交叉贴胸",
        "用双腿推地，让泡沫轴沿背部缓慢向中下背滚动",
        "到位后，上半身向后伸展、靠到泡沫轴上",
        "保持 PT 指定时长（默认 3–5 秒）—— 感受胸椎被打开",
        "腿推动 + 后仰算 1 次。共 10 次/组"
      ],
      cues: [
        "⭐ 跟抱头版本不同：手贴胸，颈部要自己稳——觉得颈椎吃力就先做抱头版",
        "腿是发动机，不是上半身——靠腿推动滚轴位置",
        "腰不能参与；如果觉得腰在压，用手撑一下臀部",
        "右肩 PT HEP（2026-05-13 起）—— 每周做 3 次"
      ],
      breath: "后仰时呼气，回位吸气"
    },
    {
  ...
  upper: [
    ...
    {
      name: "双侧肩外旋（弹力带）", sets: "3组 × 6次", badge: "PT HEP",
      timerType: "reps", reps: 6, sets_n: 3,
      brief: "双肘贴身 · 腋下夹毛巾 · 双手拉开弹力带激活肩袖",
      category: "warmup",
      setup: "站姿或坐姿均可。双手各握弹力带一端；在每侧肘窝与肋骨之间夹一条小毛巾（PT 新增提示——掉了就是肘外飘了）。肘关节弯曲 90 度并贴身体两侧，前臂朝正前方、掌心朝上。肩膀下沉，不要耸肩。",
      steps: [
        "起始位：前臂朝前，弹力带轻微张力，双肘夹住毛巾",
        "保持双肘贴住肋骨两侧——肘角度全程 90 度不变",
        "前臂缓慢向外旋转、向身体两侧打开",
        "感受肩胛后侧和肩袖发力",
        "缓慢回到起始位，完成 1 次"
      ],
      cues: [
        "⭐ 毛巾不能掉——肘外飘了毛巾就会掉，这是 PT 的本体感觉提示",
        "⭐ 肘必须全程贴身，不要为了拉更开而肘外飘",
        "动作要慢：2秒外旋、2秒回位",
        "不要耸肩——保持肩膀下沉",
        "感受点应在肩胛骨后面（冈下肌、小圆肌区域），不是手腕在硬拽",
        "右肩康复期（2026-05-13 起）—— 量从 3×12 降到 3×6，重质量不堆 volume"
      ],
      breath: "外旋时呼气，回位吸气"
    },
    {
      name: "肩胛时钟 Scapular Clock", sets: "2组 × 每侧6轮", badge: "PT HEP",
      timerType: "reps", reps: 6, sets_n: 2,
      brief: "弹力带套手腕，手沿墙面滑向时钟方向",
      category: "warmup",
      setup: "面对墙站立，弹力带套在双手手腕。双肘弯曲，前臂靠近墙面。左手保持稳定，右手准备沿墙滑动；换边时方向镜像。",
      steps: [
        "右手沿墙滑到1点方向，然后回到起始位",
        "右手滑到3点方向，然后回到起始位",
        "右手滑到5点方向，然后回到起始位",
    ...
    {
      name: "弹力带 PNF D2", sets: "3组 × 10次", badge: "PT HEP",
      timerType: "reps", reps: 10, sets_n: 3,
      brief: "高位固定弹力带，手臂从上方向身体对侧下拉",
      category: "main",
      setup: "将弹力带固定在较高位置，身体侧对固定点。靠近固定点的手握住弹力带，起始时手在头顶上方略偏外侧，手肘伸直。",
      steps: [
        "从头顶外侧起始，肩膀下沉",
        "保持手肘伸直，手臂向下、向身体对侧画斜线",
        "下拉到可控终点，感受肩胛和背部参与",
        "缓慢回到起始位",
        "完成10次后换边"
      ],
    ...
    {
      name: "前锯肌俯卧撑 Serratus Push Up", sets: "3组 × 10次", badge: "PT HEP",
      timerType: "reps", reps: 10, sets_n: 3,
      brief: "手臂伸直，只做肩胛前推和回收",
      category: "main",
      setup: "进入高位平板或墙面支撑版本。双手在肩膀正下方，手肘保持伸直但不锁死，身体成一条直线。",
      steps: [
        "保持手肘伸直，不做普通俯卧撑弯肘",
        "胸口轻轻向地面/墙面靠近，让肩胛骨向中间靠拢",
        "再用双手推地，把上背部向外推圆一点",
        "感受肩胛骨沿肋骨滑动，完成1次",
        "共做10次"
      ],
